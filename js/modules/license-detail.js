                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            ${activeEmployees.length === 0 ? `
                                <div class="form-hint" style="color: #f97316; margin-bottom: 0.5rem;">
                                    ${totalQuantity > 0 && available <= 0 ? 'No hay licencias disponibles' : 'Todos los empleados ya tienen esta licencia asignada'}
                                </div>
                            ` : `
                                <div style="position: relative;">
                                    <div class="search-group" style="margin-bottom: 0; position: relative; display: flex; align-items: center; gap: 0.75rem; padding: 0.625rem 1rem; background: var(--bg-tertiary); border: 1px solid var(--border-color); border-radius: 10px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="color: var(--text-tertiary); flex-shrink: 0;">
                                            <circle cx="11" cy="11" r="8"></circle>
                                            <path d="m21 21-4.35-4.35"></path>
                                        </svg>
                                        <input type="text" 
                                    ...
                                    <div id="employeeDropdown" 
                                        ...
                                        ${activeEmployees.map(e => `
                                            <div class="employee-option" 
                                                 ...
                                                 onclick="LicenseDetailModule.selectEmployee('${e.id}', '${this.escapeHtml(e.name)} ${this.escapeHtml(e.lastName || '')}${e.employeeNumber ? ` - #${e.employeeNumber}` : ''}')">
                                ...
                                <div id="selectedEmployeeDisplay" style="margin-top: 0.5rem; padding: 0.75rem; background: var(--hover-bg); border-radius: 6px; display: none;">
                                    <div style="display: flex; align-items: center; justify-content: space-between;">
                                        ...
                                        <button type="button" 
                                                onclick="LicenseDetailModule.clearEmployeeSelection()"
