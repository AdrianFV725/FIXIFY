...
const Sidebar = {
    ...
    render() {
        ...
        this.container.innerHTML = `
            <div class="sidebar-header">
                <a href="${isEmployee ? 'employee-dashboard.html' : 'dashboard.html'}" class="sidebar-logo">
    ...
    renderNavSections() {
        ...
        // Si es empleado, mostrar menú simplificado
        if (isEmployee) {
        ...
        // Para usuarios y admin, mostrar menú completo
